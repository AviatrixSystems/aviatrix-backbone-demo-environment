...
module "backbone" {
  ...
  gcp_shared_secret               = local.tfvars.gcp_shared_secret
  oci_backbone_compartment_ocid   = local.tfvars.oci_backbone_compartment_ocid
  oci_shared_secret               = local.tfvars.oci_shared_secret
